...
This issue does not repro when we make the LoadFromWic call synchronously on a .heic with no other concurrent calls. With non-heic files, concurrent LoadFromWic calls don't repro the issue either and all complete successfully.
